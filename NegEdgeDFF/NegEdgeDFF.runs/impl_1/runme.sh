...
HD_PWD='/home/alpha/Documents/FPGA/NegEdgeDFF/NegEdgeDFF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NegEdgeDFF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NegEdgeDFF.tcl -notrace
