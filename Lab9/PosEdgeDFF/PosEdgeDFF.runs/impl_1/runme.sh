...
HD_PWD='/home/alpha/Documents/FPGA/PosEdgeDFF/PosEdgeDFF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PosEdgeDFF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PosEdgeDFF.tcl -notrace
