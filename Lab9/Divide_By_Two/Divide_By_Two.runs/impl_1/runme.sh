...
HD_PWD='/home/alpha/Documents/FPGA/Divide_By_Two/Divide_By_Two.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Divide_by_Two.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Divide_by_Two.tcl -notrace
