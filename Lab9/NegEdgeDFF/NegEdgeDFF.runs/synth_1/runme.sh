...
HD_PWD='/home/alpha/Documents/FPGA/NegEdgeDFF/NegEdgeDFF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NegEdgeDFF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NegEdgeDFF.tcl
