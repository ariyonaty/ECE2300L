...
HD_PWD='/home/alpha/Documents/FPGA/Button_Counter/Button_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_counter.tcl
