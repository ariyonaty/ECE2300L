...
HD_PWD='/home/alpha/Documents/FPGA/Divide_By_Two/Divide_By_Two.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Divide_by_Two.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Divide_by_Two.tcl
